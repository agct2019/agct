class History implements Debuggable{
    ...
    public static String [] SUMMARY_OF_CHANGES = {"Bugs corrected; added search facility for clustering.",
						  ...
						  "Minor bugs corrected (JSelectionPane Ligands)",
						  "Added save major wavelet coefficients",
						  "Added save scaling function coefficient or not",
						  "Added drag + zoom on HC",
						  "Added filtering by distances",
						  "Added Bethe Hessian clustering",
						  "Added manifold dimension estimation",
						  "Corrections to manifold dimension estimation",
						  "Version submitted for Journal consideration",
						  "Added PCA renormalization"};
