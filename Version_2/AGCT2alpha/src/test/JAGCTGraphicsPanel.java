...
public class JAGCTGraphicsPanel extends JPanel implements MouseListener,
    ...
    public static final Color myColor = Color.BLACK;
    public static final Color highlightColor = Color.orange; // Color.red;
    public static final Color paramColor = Color.blue;
    public static final Color structColor = Color.lightGray; // Color.green;
    ...
    public static final Color[] responsiveGeneColors = {
            new Color(0xFF9900),
            new Color(0xFF00CC),
            new Color(0x00FFFF),
            new Color(0x993300),
    ...
    public void initAll(boolean yO) {
