...
//            ktarg = (double) aa.numberOfClusters;
...
//            aa = ((Clustering) myAGCT.data.getAllClusterings().elementAt(i)).myClusteringAlgorithm;
...
//                aa = ((Clustering) myAGCT.data.getAllClusterings().elementAt(((Integer) indices.elementAt(i)).intValue())).myClusteringAlgorithm;
...
//                allValues.addElement(new Integer(aa.numberOfClusters));
//
//                if ((i == 0) || (dni < miny))
//                    miny = dni;
//
...
//        for (i = 0; i < myAGCT.data.getAllClusterings().size(); i++) {
//            aa = ((Clustering) myAGCT.data.getAllClusterings().elementAt(i)).myClusteringAlgorithm;
//            if ((i == 0) || (aa.numberOfClusters < rX[0]))
//                rX[0] = aa.numberOfClusters;
//            if ((i == 0) || (aa.numberOfClusters > rX[1]))
//                rX[1] = aa.numberOfClusters;
//
//            rat = refY(aa, 0, dORs);
//            if ((i == 0) || (rat < rY[0]))
//                rY[0] = rat;
...
//
//                g.setFont(JConfig.SMALL_FONT);
//                g.drawString(gg.myID + "(" + gg.asciiName + ")", xx, yy + pointRadius);
//            }
//
//            first = false;
//        }
